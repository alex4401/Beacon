...
var update_checkout_components = function() {
	if (is_child) {
		document.getElementById('slots_row').className = 'hidden';
	} else {
		document.getElementById('slots_row').className = '';
	}
...
<div id="page_cart" class="hidden">
	...
	<table class="generic">
		...
		<tr id="slots_row">
			...
			<td class="quantity_column"><input class="text-center" type="number" value="0" id="slot_quantity_field" min="0" max="20"></td>
