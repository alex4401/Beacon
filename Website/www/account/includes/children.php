...
foreach ($children as $child) {
	...
	echo '<tr>';
	echo '<td>' . htmlentities($child->Username()) . '<span class="user-suffix">#' . htmlentities($child->Suffix()) . '</span><div class="mobile-actions separator-color text-lighter">' . ($child->IsEnabled() ? 'Enabled' : 'Disabled') . ' | ' . implode(' | ', $action_links) . '</div></td>';
